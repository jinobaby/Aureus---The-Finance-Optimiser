            ...
            <div className='home-container-nav'>
                ...
                <div className='home-container-nav-bottom'>
                    ...
                    <div className='home-container-nav-bottom-right'>
                        ...
                        <button style={{ backgroundColor: 'var(--color-bg-card)', color: 'var(--color-accent)' }} className='home-container-nav-bottom-button home-container-nav-bottom-button-specific' onClick={() => navigate('/User-login')} >Sign In</button>
                    </div>
